...
var GetStarted, Page, React, ReactDOM, RemoveImages, StepFour, StepOne, StepThree, StepTwo, Summary, a, div, h1, h3, p, ref;
    ...
    switch (this.state.screen) {
      ...
      case 'step-three':
        local_comp = React.createElement(StepThree, {
          ...
          data: this.state.data.stepTwo,
          updateData: this.updateData,
          old_data: this.state.data.stepThree
        });
        break;
      case 'step-four':
